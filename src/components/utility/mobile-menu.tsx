            ...
            <Dialog.Panel className="pointer-events-none absolute flex min-h-[85%] w-full flex-col items-center justify-center overflow-y-auto rounded-b-2xl border-2 border-accent/20 bg-background px-6 py-8 text-accent shadow-lg shadow-accent/10 md:px-10 md:py-16">
              <div className="pointer-events-auto flex flex-col items-center gap-6 text-center">
                ...
                <a
                  ...
                  download
                  className="mt-2 rounded-full bg-accent px-6 py-2 text-lg font-semibold text-background transition-colors duration-200 hover:bg-accent/80 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2"
                >
                  Download Resume
                </a>
              </div>
              <div className="absolute bottom-0 py-6">©2023 Rugved Gurav</div>
            </Dialog.Panel>
          </Transition.Child>
        </div>
      </Dialog>
